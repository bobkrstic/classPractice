...
db.students.update({"name": "Alex", "hobbies": "Estreme Basketweaving"});
db.classroom.udate({name: "Steve"}, {$push: {"hobbies": "Extreme Basketweaving"}});

// 2. While practicing for your Extreme Basketweaving Competition, 
// you broke the computer of the person next to you. 
db.classroom.udate({name: "Alex"}, {$set: {"os": "Win"}});
...
db.classroom.update({name: "Bob"}, {$set: {"gavecandy": "true"}})
